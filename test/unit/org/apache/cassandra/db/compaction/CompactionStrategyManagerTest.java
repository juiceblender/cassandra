...
public class CompactionStrategyManagerTest
{
    ...
    public void testSSTablesAssignedToCorrectCompactionStrategy(int numSSTables, int numDisks)
    {
        ...
        CompactionStrategyManager csm = new CompactionStrategyManager(cfs, () -> cfs.getDiskBoundaries(Directories.DirectoryType.STANDARD)
        , true, Directories.DirectoryType.STANDARD);
